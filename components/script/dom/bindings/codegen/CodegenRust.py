...
""" % (descriptor.name, parent)
        ...
        if descriptor.isGlobal():
            create += "let obj = RootedObject::new(cx, create_dom_global(cx, &Class.base as *const js::jsapi::Class as *const JSClass));\n"
        else:
            create += ("let obj = {\n"
                       "    let _ac = JSAutoCompartment::new(cx, proto.ptr);\n"
...
class CGBindingRoot(CGThing):
    ...
    def __init__(self, config, prefix, webIDLFile):
        ...
        curr = CGImports(curr, descriptors + callbackDescriptors, mainCallbacks, [
            ...
            'js::jsapi::{JS_NewObjectWithGivenProto, IsCallable, JS_SetPrototype}',
