...
use dom::node::Node;
use js::jsapi::{JSContext, JSObject, Heap, JSTracer, HandleObject, RootedValue, RootedObject};
...
impl RootCollection {
    ...
    pub fn new() -> RootCollection {
        RootCollection {
            roots: UnsafeCell::new(Vec::with_capacity(2048)),
        }
    }

    /// Start tracking a stack-based root
    fn root<'b>(&self, obj: NonZero<*mut JSObject>)
                -> (*const *mut JSObject, usize) {
