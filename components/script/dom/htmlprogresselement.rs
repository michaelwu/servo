...
impl HTMLProgressElement {
    fn new_inherited(&mut self, localName: DOMString,
                     ...
                     document: &Document) {
        self.htmlelement.new_inherited(HTMLElementTypeId::HTMLProgressElement, localName, prefix, document)
    }
    ...
    pub fn new(localName: DOMString,
        ...
        let mut obj = Node::alloc_node::<HTMLProgressElement>(document);
